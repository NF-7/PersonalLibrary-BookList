...
document.getElementById('book-form').addEventListener('submit', function(e) {
    ...
    if (ui.title.value === '' || ui.author.value === '' || (ui.isbn.value === '' || isNaN (Number(ui.isbn.value)))) {
        ui.showAlert('Prosimo izpolnite vsa polja z veljavnimi podatki!', 'error');
        e.preventDefault();
        return;
    }
    ...
    ui.addBookToList();
    ui.clearInputValues();
    ui.showAlert('Vaša knjiga je bila uspešno dodana!', 'success');
    e.preventDefault();
})
...
UI.prototype.addBookToList = function(savedBook = null) {
    ...
    removeButton.addEventListener('click', function(e) {
        ...
        ui.showAlert('Knjiga je bila uspešno odstranjena!', 'success');
    });
